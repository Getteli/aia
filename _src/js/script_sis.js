...
recognition.onend = function(event) {
	console.log("acabou de ouvir (pelo end),. " + startTime());
	// if (!loopspeak) {
		// console.log('vou entrar no endRecog, aqui no onend');
		// endRecog(); // inicia a funcao para terminar de gravar
		// loopspeak = false;
	// }
	if ( loop ) {
		console.log("o loop é "+loop+", entao continue gravando, em um loop");
		recognizing = false;
		startRecog();
	}else{
		console.log("o loop é "+loop+", entao ainda nao volto a gravar em loop");
	}
}
